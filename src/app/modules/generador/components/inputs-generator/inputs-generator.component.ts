      ...
      },
      {
        ...
        values: [
          ...
          },
          {
            ...
            orden: 8,
            label: '¿Cuáles son los ingresos mensuales promedio de la familia?',
            description: null,
            type: 'select',
            options: [
              {
          ...
          },
          {
            ...
            orden: 46,
            label: '¿Acostumbran encender velas/velones dentro de su vivienda?',
            description: null,
            type: 'check',
            options: { valueTrue: 'Sí', valueFalse: 'No' },
            default: null,
        ...
        values: [
          {
            ...
            orden: 1,
            label: '¿En la vivienda hay niños y/o niñas menores de cinco años?',
            description: null,
            type: 'check',
            options: { valueTrue: 'Sí', valueFalse: 'No' },
            default: 'No',
          ...
          },
          {
            ...
            orden: 13,
            label: 'Usted o algún miembro de su familia cercana ha sufrido de:',
            description: null,
            type: 'select',
            options: [
      ...
      },
      {
        ...
        values: [
          ...
          },
          {
            ...
            orden: 2,
            label: 'Paredes: ¿cuál es el material predominante de las paredes?',
            description: null,
            type: 'select',
            options: [
              {
          ...
          },
          {
            ...
            orden: 15,
            label: '¿La casa cuenta con los siguientes elementos por separado?',
            description: null,
            type: 'text',
            options: null,
            default: null,
      ...
      },
      {
        ...
        values: [
          ...
          },
          {
            ...
            orden: 19,
            label: '¿Siente deseos de volver al sitio de donde fue desplazado?',
            description: null,
            type: 'text',
            options: null,
            default: null,
          ...
          },
          {
            ...
            orden: 24,
            label: '¿Se siente a gusto en la vivienda que habita actualmente?',
            description: null,
            type: 'text',
            options: null,
            default: null,
